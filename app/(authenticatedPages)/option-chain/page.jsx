      ...
      <Table>
        <TableHeader>
          <TableRow className="border-slate-700 bg-slate-800 text-xs">
            <TableHead className="sticky top-0 bg-slate-800 z-10 text-yellow-300 text-center">Offer</TableHead>
            <TableHead className="sticky top-0 bg-slate-800 z-10 text-center">Int Val F</TableHead>
            <TableHead className="sticky top-0 bg-slate-800 z-10 text-center">Int Val S</TableHead>
            <TableHead className="sticky top-0 bg-slate-800 z-10 text-center">Time Val</TableHead>
            <TableHead className="sticky top-0 bg-slate-800 z-10 text-center">Breakeven(%)</TableHead>
            <TableHead className="sticky top-0 bg-slate-800 z-10 text-center">LTP Chg</TableHead>
            <TableHead className="sticky top-0 bg-slate-800 z-10 text-center">LTP(%)</TableHead>
            <TableHead className="sticky top-0 bg-slate-700 z-10 text-white text-center">Strike</TableHead>
            <TableHead className="sticky top-0 bg-slate-800 z-10 text-center">LTP(%)</TableHead>
            <TableHead className="sticky top-0 bg-slate-800 z-10 text-center">LTP Chg</TableHead>
            <TableHead className="sticky top-0 bg-slate-800 z-10 text-center">Breakeven(%)</TableHead>
            <TableHead className="sticky top-0 bg-slate-800 z-10 text-center">Time Val</TableHead>
            <TableHead className="sticky top-0 bg-slate-800 z-10 text-center">Int Val S</TableHead>
            <TableHead className="sticky top-0 bg-slate-800 z-10 text-center">Int Val F</TableHead>
            <TableHead className="sticky top-0 bg-slate-800 z-10 text-green-300 text-center">Offer</TableHead>
          </TableRow>
        </TableHeader>
